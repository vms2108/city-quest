...
@Component({
  selector: 'cq-screen-way',
  templateUrl: './screen-way.component.html',
  styleUrls: ['./screen-way.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ScreenWayComponent implements OnChanges {
