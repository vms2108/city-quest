      ...
      blocks: [
        new ScreenBlock(BlockTypesEnum.QUESTION, 'Дворцовый мост днём ведёт из Адмиралтейства на Васильевский остров. А куда он ведёт по ночам?', '', [
          ...
          'Вверх',
                        ...
                        'Представьте, что вы умеете ходить по вертикальным поверхностям и решили прогуляться по разведённому мосту. В каком направлении вы бы тогда двигались?'),
      ],
    },
    {
      id: '003',
    ...
    },
    {
      ...
      blocks: [
        ...
        Шпиль прозовут “адмиралтейская ...`,
                        '',
                        ['Игла'],
                        'Ответ кроется на одном из предыдущих экранов'),
      ],
    },
    {
      id: '007',
