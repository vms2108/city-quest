import { AdminArrayControlComponent } from './array/admin-array-control.component';
import { AdminBlockTypeControlComponent } from './block-type/admin-block-type-control.component';
...
export const ADMIN_CONTROL_COMPONENTS = [
  AdminParametersControlComponent,
  AdminArrayControlComponent,
  AdminScreenTypeControlComponent,
